### This script estimates largeTreeNPP based on dendrometer data
...
plotname = 1
allometric_option = "moist"

#largeTreeNPP_census <- function(census, dendrometer_db, plotname, 
#                         allometric_option=allometric_option,
#                         plotit=F) {
...
#### it follows: calculation of large tree NPP
...
#%corner of plot, (8) bole form for live trees, (9) type of dead
#%tree
...
#% Dendrometer altura (m)	
#% DAP (cm) 11/2008
#% DAP 20/12/2009	
#% DAP 15/12/2010
#% 20/01/2009 y 22/01/2009	
#% 20/02/2009 y 22/02/2009	
#% 20/03/2009 y 22/03/2009	
#% 19/04/2009 y 21/04/2009	
#% 20/05/2009 y 22/05/09	
#% 20/06/2009 y 23/06/2009	
#% 19/07/2009 y 22/07/2009	
#% 21/08/2009 y 23/08/2009	
#% 19/09/2009 y 22/09/2009	
#% 20/10/2009 y 23/10/2009	
#% 20/11/2009 y 23/11/2009	
#% 19/12/2009 y 21/12/2009	
#% 20/01/2010 y 24/01/2010	
#% 20/02/2010 y 22/02/2010	
#% 20/03/2010 y 22/03/2010	
#% 20/04/2010 y 24/04/2010	
#% 20/05/2010 y 22/05/2010	
#% 20/06/2010 y 22/05/2010	
#% 20/07/2010 y 21/07/2010	
#% 20/08/2010 y 21/08/2010	
#% 20/09/2010 y 21/09/2010
#% 20/10/2010 y 21/09/2010	
#% 20/11/2010 y 21/11/2010	
#% 20/12/2010 y 21/12/2010	
#% 20/01/2011 y 23/01/2011	
#% 20/02/2011 y 23/02/2011	
#% 20/03/2011 y 23/03/2011	
#% 20/04/2011 y 23/04/2011	
#% 20/05/2011 y 23/05/2011	
#% 20/06/2011 y 23/06/2011	
#% 20/07/2011 y 23/07/2011	
#% 20/08/2011 y 23/08/2011	
#% 20/09/2011 y 23/08/2011
...
## Build list with matrices that contain monthly values in time series structure:
{
  largeTreeNPP.ts <- list(
    NPPwoodA)
}
...
if (plotit==T) {
  ...
  dates <- as.character(strptime(dates_monthly,
                                 format="%Y-%m-%d"))
  
  x11()
  par(mfrow=c(3,1))
  par(mar=c(4,4,0.5,0.5))
  plot(x=strptime(dates, format="%Y-%m-%d"), y=largeTreeNPP.ts[[1]], 
       type='l',lwd=2,
       xlab="Years", ylab="large Tree NPP [Mg C ha-1 mo-1]")
  legend("topleft", c("Large Tree NPP"), lty=c(1), bty='n')
}


# Return time series
return(largeTreeNPP.ts)
}