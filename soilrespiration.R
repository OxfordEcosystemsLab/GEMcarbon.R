...
# This function calculates soil respiration and uses input data specified in the 
# RAINFOR-GEM manual.
...
#### Partitioning Soil Repiration calculation (data was assigned to vectors above!)
    # remove outliers and NAs: Flux (sd > 3), Temperature and Chamber height (see functions!)
