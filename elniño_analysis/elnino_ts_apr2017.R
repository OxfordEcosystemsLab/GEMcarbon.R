...
write.csv(sea, file="ts_flf_2017_sea.csv")
write.csv(sa, file="ts_flf_2017_sa.csv")
...
# "KEN-01" "KEN-02" - tree tags in dendrometer data do not coincide with tree tags in census from forest plots? 
#
