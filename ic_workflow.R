...
# read in data
xx <- read.csv("ic_20180521.csv", sep=",", header=T, stringsAsFactors=FALSE) #ic_20180129.csv
datafile = subset(xx, plot_code %in% c("STN-02", "STN-03", "STN-04", "STD-10", "STO-07", "STD-11", "STL-09", "STL-10", "STJ-04", "PAN-03", "PAN-02", "TRU-04", "ACJ-01", "STB-08", "STB-12", "STJ-01", "STO-03", "STJ-05", "STO-06", "STN-06", "STN-09", "STD-05", 
                                       "JEN-03", "JEN-11", "JEN-12", "TAM-05", "TAM-06", "TAM-09", "ALP-11", "ALP-12", "BOB-04", "BOB-02", "BOB-03", "BOB-01", "BOB-05", "BOB-06", "BLZ-11", "BLZ-12", "BLZ-21", "BLZ-22",
                                       "KEN-01", "KEN-02", "TAN-01", "TAN-02", "ANK-01", "ANK-02", "ANK-03", "KOG-02", "KOG-03", "KOG-04", "KOG-05", "KOG-06","MNG-03", "MNG-04", "LPG-01", "LPG-02", "IVI-01", "IVI-02", "DAN-04", "DAN-05", "MLA-01",
                                       "MLA-02", "OP", "SAF-01", "SAF-02", "SAF-03", "SAF-04", "SAF-05", "NXV-02", "NXV-01", "STQ-08", "STQ-11"))
